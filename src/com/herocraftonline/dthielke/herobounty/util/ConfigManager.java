...
public class ConfigManager {
    ...
    public void load() {
        ...
        bountyManager.setDurationReduction(config.getInt("contract-hunterkill-reduction", 24 * 60));
        bountyManager.setContractDelay(config.getInt("contract-save-delay", 300));
        ...
        bountyManager.setTargetInformationCooldown(config.getInt("target-information-cooldown", 120));
